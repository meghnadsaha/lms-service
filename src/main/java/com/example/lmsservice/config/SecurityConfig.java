...
import com.example.lmsservice.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain ( HttpSecurity http ) throws Exception {
        return http.csrf().disable()
                   ...
                   // Permit access to Swagger UI for specific request matchers
                   .requestMatchers("/swagger-ui/**" , "/swagger-ui.html" , "/v3/api-docs/**").permitAll()
                   // Add other request matchers that require authentication
                   .requestMatchers(
                           "/api/auth/signUp" ,
                           "/api/auth/login" ,
